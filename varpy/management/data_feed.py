...
def ecvd( obj1, data_file, metadata_file=None):
    ...
    elif obj1.ecvd.metadata['location'] == 'IMO':
        obj1.ecvd.dataset = volc_importers.IMO_ecvd(data_file)
    elif obj1.ecvd.metadata['location'] == 'HVO':
        obj1.ecvd.dataset, obj1.ecvd.location_data = volc_importers.HVO_ecvd(data_file)
