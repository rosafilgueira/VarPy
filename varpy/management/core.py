...
class Var_Data():
    ...
    def __var_data(self,ID):
        ...
        """
        self.id=ID
        self.figure_path= './'+ self.id + '/Figure'
...
class Generic_Data():
    ...
    def update_last_model_output(self, model_name,model_output):
        
        self.models[model_name].outputs[-1]=model_output 
