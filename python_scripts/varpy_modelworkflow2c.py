...
kwargs={'spatial':'latlon','spatial_x_min':lat_min,'spatial_x_max':lat_max,'spatial_y_min':lon_min,'spatial_y_max':lon_max,'single_attribute':'depth','z_max':z_max, 'z_min':z_min,'mag_comp':mag_comp,'t_min':t_min, 't_max':t_max,'t_step':t_step}
